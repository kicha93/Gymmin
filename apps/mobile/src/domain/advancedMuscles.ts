...
export const advancedMuscleSubdivisions: readonly AdvancedMuscleSubdivision[] = [
  subdivision("chest.clavicular", "chest", "chest", "Część obojczykowa", "Clavicular region", "front", ["left_pectoralis_major_clavicular", "right_pectoralis_major_clavicular"]),
  subdivision("chest.sternocostal", "chest", "chest", "Część mostkowo-żebrowa", "Sternocostal region", "front", ["left_pectoralis_major_sternocostal", "right_pectoralis_major_sternocostal"]),
  subdivision("chest.abdominal", "chest", "chest", "Część brzuszna (dolna)", "Abdominal (lower) region", "front", ["left_pectoralis_major_abdominal", "right_pectoralis_major_abdominal"]),
  subdivision("shoulders.anteriorDeltoid", "shoulders", "shoulders", "Akton przedni", "Anterior deltoid", "front", ["left_deltoid_anterior", "right_deltoid_anterior"]),
  subdivision("shoulders.lateralDeltoid", "shoulders", "shoulders", "Akton boczny", "Lateral deltoid", "front", ["left_deltoid_lateral", "right_deltoid_lateral"]),
  ...
  subdivision("triceps.longHead", "triceps", "triceps", "Głowa długa", "Long head", "back", ["left_triceps_brachii_long_head", "right_triceps_brachii_long_head"]),
  subdivision("triceps.lateralHead", "triceps", "triceps", "Głowa boczna", "Lateral head", "back", ["left_triceps_brachii_lateral_head", "right_triceps_brachii_lateral_head"]),
  subdivision("triceps.medialHead", "triceps", "triceps", "Głowa przyśrodkowa", "Medial head", "back", ["left_triceps_brachii_medial_head", "right_triceps_brachii_medial_head"]),
  subdivision("elbowFlexors.bicepsLongHead", "elbowFlexors", "biceps", "Głowa długa bicepsa", "Biceps long head", "front", ["left_biceps_brachii_long_head", "right_biceps_brachii_long_head"]),
  subdivision("elbowFlexors.bicepsShortHead", "elbowFlexors", "biceps", "Głowa krótka bicepsa", "Biceps short head", "front", ["left_biceps_brachii_short_head", "right_biceps_brachii_short_head"]),
  ...
  subdivision("abs.rectusAbdominis", "abs", "abs", "Mięsień prosty brzucha", "Rectus abdominis", "front", ["left_rectus_abdominis_upper", "left_rectus_abdominis_middle", "left_rectus_abdominis_lower", "right_rectus_abdominis_upper", "right_rectus_abdominis_middle", "right_rectus_abdominis_lower"]),
  subdivision("abs.transversusAbdominis", "abs", "abs", "Mięsień poprzeczny brzucha", "Transversus abdominis", "front", [], false),
  subdivision("obliques.externalOblique", "obliques", "obliques", "Mięsień skośny zewnętrzny", "External oblique", "front", ["left_external_oblique_upper", "left_external_oblique_lower", "right_external_oblique_upper", "right_external_oblique_lower", "right_external_oblique_upper_small_detail"]),
  subdivision("obliques.internalOblique", "obliques", "obliques", "Mięsień skośny wewnętrzny", "Internal oblique", "front", [], false),
  subdivision("quadriceps.rectusFemoris", "quadriceps", "quads", "Mięsień prosty uda", "Rectus femoris", "front", ["left_quadriceps_rectus_femoris", "right_quadriceps_rectus_femoris"]),
  subdivision("quadriceps.vastusLateralis", "quadriceps", "quads", "Mięsień obszerny boczny", "Vastus lateralis", "front", ["left_quadriceps_vastus_lateralis", "right_quadriceps_vastus_lateralis"]),
  subdivision("quadriceps.vastusMedialis", "quadriceps", "quads", "Mięsień obszerny przyśrodkowy", "Vastus medialis", "front", ["left_quadriceps_vastus_medialis", "right_quadriceps_vastus_medialis"]),
  subdivision("quadriceps.vastusIntermedius", "quadriceps", "quads", "Mięsień obszerny pośredni", "Vastus intermedius", "front", [], false),
  subdivision("hamstrings.bicepsFemorisLongHead", "hamstrings", "hamstrings", "Dwugłowy uda — głowa długa", "Biceps femoris long head", "back", ["left_biceps_femoris", "right_biceps_femoris"]),
  ...
  subdivision("hamstrings.semitendinosus", "hamstrings", "hamstrings", "Mięsień półścięgnisty", "Semitendinosus", "back", ["left_semitendinosus", "right_semitendinosus"]),
  subdivision("hamstrings.semimembranosus", "hamstrings", "hamstrings", "Mięsień półbłoniasty", "Semimembranosus", "back", ["left_semimembranosus", "right_semimembranosus"]),
  subdivision("glutes.gluteusMaximus", "glutes", "glutes", "Mięsień pośladkowy wielki", "Gluteus maximus", "back", ["left_gluteus_maximus_upper_fibers", "left_gluteus_maximus_lower_fibers", "right_gluteus_maximus_upper_fibers", "right_gluteus_maximus_lower_fibers"]),
  subdivision("glutes.gluteusMedius", "glutes", "glutes", "Mięsień pośladkowy średni", "Gluteus medius", "back", ["left_gluteus_medius_visible", "right_gluteus_medius_visible"]),
  subdivision("glutes.gluteusMinimus", "glutes", "glutes", "Mięsień pośladkowy mały", "Gluteus minimus", "back", [], false),
  subdivision("calves.gastrocnemius", "calves", "calves", "Mięsień brzuchaty łydki", "Gastrocnemius", "back", ["left_gastrocnemius_medial_head", "left_gastrocnemius_lateral_head", "right_gastrocnemius_medial_head", "right_gastrocnemius_lateral_head"]),
  subdivision("calves.soleus", "calves", "calves", "Mięsień płaszczkowaty", "Soleus", "back", ["left_soleus", "right_soleus"]),
  subdivision("upperBack.trapeziusUpper", "upperBack", "traps", "Mięsień czworoboczny — część górna", "Upper trapezius", "back", ["left_upper_trapezius_neck_center", "right_upper_trapezius_neck_center", "left_trapezius_upper_fibers", "right_trapezius_upper_fibers"]),
  subdivision("upperBack.trapeziusMiddle", "upperBack", "traps", "Mięsień czworoboczny — część środkowa", "Middle trapezius", "back", ["left_trapezius_middle_fibers", "right_trapezius_middle_fibers"]),
  subdivision("upperBack.trapeziusLower", "upperBack", "traps", "Mięsień czworoboczny — część dolna", "Lower trapezius", "back", ["left_trapezius_lower_fibers", "right_trapezius_lower_fibers"]),
  subdivision("upperBack.rhomboids", "upperBack", "traps", "Mięśnie równoległoboczne", "Rhomboids", "back", [], false),
  subdivision("spinalErectors.thoracic", "spinalErectors", "lowerBack", "Odcinek piersiowy", "Thoracic region", "back", ["left_erector_spinae_thoracic_iliocostalis", "left_erector_spinae_thoracic_longissimus", "left_erector_spinae_thoracic_spinalis", "right_erector_spinae_thoracic_iliocostalis", "right_erector_spinae_thoracic_longissimus", "right_erector_spinae_thoracic_spinalis"]),
  subdivision("spinalErectors.lumbar", "spinalErectors", "lowerBack", "Odcinek lędźwiowy", "Lumbar region", "back", ["left_erector_spinae_lumbar_iliocostalis", "left_erector_spinae_lumbar_longissimus", "left_erector_spinae_lumbar_spinalis", "right_erector_spinae_lumbar_iliocostalis", "right_erector_spinae_lumbar_longissimus", "right_erector_spinae_lumbar_spinalis"])
];
