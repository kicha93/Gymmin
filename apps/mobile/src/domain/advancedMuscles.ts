...
export const advancedMuscleSubdivisions: readonly AdvancedMuscleSubdivision[] = [
  subdivision("chest.clavicular", "chest", "chest", "Część obojczykowa", "Clavicular region", "front", ["advanced_left_chest_clavicular", "advanced_right_chest_clavicular"]),
  subdivision("chest.sternocostal", "chest", "chest", "Część mostkowo-żebrowa", "Sternocostal region", "front", ["advanced_left_chest_sternocostal", "advanced_right_chest_sternocostal"]),
  subdivision("chest.abdominal", "chest", "chest", "Część brzuszna (dolna)", "Abdominal (lower) region", "front", ["advanced_left_chest_abdominal", "advanced_right_chest_abdominal"]),
  subdivision("shoulders.anteriorDeltoid", "shoulders", "shoulders", "Akton przedni", "Anterior deltoid", "front", ["advanced_left_deltoid_anterior", "advanced_right_deltoid_anterior"]),
  subdivision("shoulders.lateralDeltoid", "shoulders", "shoulders", "Akton boczny", "Lateral deltoid", "front", ["advanced_left_deltoid_lateral", "advanced_right_deltoid_lateral"]),
  ...
  subdivision("triceps.longHead", "triceps", "triceps", "Głowa długa", "Long head", "back", [], false),
  subdivision("triceps.lateralHead", "triceps", "triceps", "Głowa boczna", "Lateral head", "back", [], false),
  subdivision("triceps.medialHead", "triceps", "triceps", "Głowa przyśrodkowa", "Medial head", "back", [], false),
  subdivision("elbowFlexors.bicepsLongHead", "elbowFlexors", "biceps", "Głowa długa bicepsa", "Biceps long head", "front", [], false),
  subdivision("elbowFlexors.bicepsShortHead", "elbowFlexors", "biceps", "Głowa krótka bicepsa", "Biceps short head", "front", [], false),
  ...
  subdivision("quadriceps.rectusFemoris", "quadriceps", "quads", "Mięsień prosty uda", "Rectus femoris", "front", ["advanced_left_quadriceps_rectus", "advanced_right_quadriceps_rectus"]),
  subdivision("quadriceps.vastusLateralis", "quadriceps", "quads", "Mięsień obszerny boczny", "Vastus lateralis", "front", ["advanced_left_quadriceps_lateralis", "advanced_right_quadriceps_lateralis"]),
  subdivision("quadriceps.vastusMedialis", "quadriceps", "quads", "Mięsień obszerny przyśrodkowy", "Vastus medialis", "front", ["advanced_left_quadriceps_medialis", "advanced_right_quadriceps_medialis"]),
  ...
  subdivision("hamstrings.semimembranosus", "hamstrings", "hamstrings", "Mięsień półbłoniasty", "Semimembranosus", "back", [], false),
  subdivision("glutes.gluteusMaximus", "glutes", "glutes", "Mięsień pośladkowy wielki", "Gluteus maximus", "back", ["advanced_left_gluteus_maximus", "advanced_right_gluteus_maximus"]),
  subdivision("glutes.gluteusMedius", "glutes", "glutes", "Mięsień pośladkowy średni", "Gluteus medius", "back", ["advanced_left_gluteus_medius", "advanced_right_gluteus_medius"]),
  subdivision("glutes.gluteusMinimus", "glutes", "glutes", "Mięsień pośladkowy mały", "Gluteus minimus", "back", [], false),
  subdivision("calves.gastrocnemius", "calves", "calves", "Mięsień brzuchaty łydki", "Gastrocnemius", "back", ["advanced_left_calf_gastrocnemius", "advanced_right_calf_gastrocnemius"]),
  subdivision("calves.soleus", "calves", "calves", "Mięsień płaszczkowaty", "Soleus", "back", ["advanced_left_calf_soleus", "advanced_right_calf_soleus"]),
  ...
  subdivision("upperBack.trapeziusMiddle", "upperBack", "traps", "Mięsień czworoboczny — część środkowa", "Middle trapezius", "back", ["advanced_left_trapezius_middle", "advanced_right_trapezius_middle"]),
  subdivision("upperBack.trapeziusLower", "upperBack", "traps", "Mięsień czworoboczny — część dolna", "Lower trapezius", "back", ["advanced_left_trapezius_lower", "advanced_right_trapezius_lower"]),
