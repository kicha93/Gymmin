...
const translations = {
  pl: {
    ...
    bugIntro: "Opisz problem. Gymmin przygotuje bezpieczną wiadomość i otworzy systemowy klient poczty.",
    ...
    bugSubmitError: "Nie udało się otworzyć klienta poczty.",
    bugSubmitting: "Przygotowywanie wiadomości...",
    ...
    privacyPolicyMeta: "Dane, odbiorcy, retencja i usuwanie",
    ...
    termsLocalDataText: "Gymmin nie wymaga konta. Dane użytkownika pozostają lokalnie na urządzeniu i mogą zostać wyeksportowane, przywrócone lub usunięte w Ustawieniach.",
    ...
    termsContactText: "W sprawach dotyczących regulaminu, prywatności lub działania aplikacji można skontaktować się pod adresem kontakt@gymmin.app. Błędy w aplikacji najlepiej zgłaszać przez formularz „Zgłoś błąd” w sekcji Informacje.",
  ...
  en: {
    ...
    bugIntro: "Describe the problem. Gymmin will prepare a safe message and open your system email app.",
    ...
    bugSubmitError: "Could not open the email app.",
    bugSubmitting: "Preparing message...",
    ...
    privacyPolicyMeta: "Data, recipients, retention and deletion",
    ...
    termsLocalDataText: "Gymmin requires no account. User data remains on the device and can be exported, restored, or deleted in Settings.",
    ...
    termsContactText: "For matters related to terms, privacy or app behavior, contact us at kontakt@gymmin.app. App bugs are best reported with the “Report a bug” form in Information.",
