...
const translations = {
  pl: {
    ...
    aiCreatorSensitiveConsent: "Wyrażam zgodę na przesłanie odpowiedzi z kreatora, w tym danych o zdrowiu, urazach, lekach i stylu życia, do Gymmin i OpenAI wyłącznie w celu wygenerowania planu treningowego.",
    aiCreatorSensitiveConsentRequired: "Przed wysłaniem danych zaznacz świadomą zgodę na ich użycie przez generator AI.",
  ...
  en: {
    ...
    aiCreatorSensitiveConsent: "I consent to sending creator answers, including health, injury, medication and lifestyle data, to Gymmin and OpenAI solely to generate a workout plan.",
    aiCreatorSensitiveConsentRequired: "Before submitting, provide informed consent for the AI generator to use this data.",
