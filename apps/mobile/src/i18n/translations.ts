...
const translations = {
  pl: {
    ...
    workoutExportSharingUnavailable: "Udostępnianie plików nie jest dostępne na tym urządzeniu.",
  ...
  en: {
    ...
    workoutExportSharingUnavailable: "File sharing is not available on this device.",
