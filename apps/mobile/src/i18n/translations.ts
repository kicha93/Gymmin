...
const translations = {
  pl: {
    ...
    localProfileName: "Nazwa użytkownika",
    localProfileNameOptional: "Nazwa jest opcjonalna i pozostaje tylko na tym urządzeniu.",
    localProfileNamePlaceholder: "Jak mamy się do Ciebie zwracać?",
  ...
  en: {
    ...
    localProfileName: "Display name",
    localProfileNameOptional: "The name is optional and stays on this device.",
    localProfileNamePlaceholder: "What should we call you?",
