    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            config.AddInMemoryCollection(new Dictionary<string, string?>
            {
                ...
                ["Gymmin:Auth:RateLimits:LoginIp:Limit"] = "1000",
                ["Gymmin:Auth:RateLimits:LoginAccount:Limit"] = "1000",
                ...
                ["Gymmin:Auth:RateLimits:PurchaseVerificationUser:Limit"] = "1000",
                ["Gymmin:Auth:RateLimits:PurchaseVerificationIp:Limit"] = "1000",
                ["Gymmin:Auth:RateLimits:ChangePasswordUser:Limit"] = "1000",
                ["Gymmin:Auth:RateLimits:ChangePasswordIp:Limit"] = "1000",
                ["Gymmin:Auth:RateLimits:PasswordResetRequestIp:Limit"] = "1000",
                ["Gymmin:Auth:RateLimits:PasswordResetRequestAccount:Limit"] = "1000",
                ["Gymmin:Auth:RateLimits:PasswordResetConfirmIp:Limit"] = "1000",
                ["Gymmin:Auth:RateLimits:PasswordResetConfirmToken:Limit"] = "1000",
