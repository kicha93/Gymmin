...
- optimized offline exercise media: 571 exercises use 650 static WebP Q90 runtime images generated reproducibly from non-bundled PNG sources; 79 have START/END pairs and 492 have one available image. Video and animated exercise media are excluded.
