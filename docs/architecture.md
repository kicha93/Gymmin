...
- `src/screens` zawiera wydzielane ekrany funkcjonalne; obecnie są tam Regulamin, Kontakt, zgłaszanie błędów, Profil z ekranami konta, Osiągnięcia, Kredyty oraz formularze logowania, rejestracji, resetu i zmiany hasła,
