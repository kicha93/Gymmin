...
- `src/screens` zawiera wydzielane ekrany funkcjonalne; obecnie są tam Regulamin, Kontakt, zgłaszanie błędów, Profil z ekranami konta oraz formularze logowania, rejestracji, resetu i zmiany hasła,
