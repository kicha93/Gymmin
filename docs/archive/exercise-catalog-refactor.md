...
> Dokument historyczny po cutover local-only. Wzmianki o backendzie, synchronizacji i testach backendu opisują dawną architekturę i nie są bieżącym zachowaniem produktu.
