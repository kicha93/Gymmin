...
- Google Play Billing cannot be tested in Expo Go. AI credit purchases require a native Android build with the billing module, package name `com.gymmin.app`, Play Console one-time products (`ai_tokens_1`, `ai_tokens_3`, `ai_tokens_10`) matching the current 1/3/10 credit packs and license testers/internal testing.
