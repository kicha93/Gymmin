...
const sample = [
  ...
  ["curl-incline-dumbbell-biceps-curl-347", "incline dumbbell"],
...
const markdown = [
  ...
  "",
  `Generated deterministically from the current ${exercises.length}-exercise catalog and final runtime profiles.`,
  "",
